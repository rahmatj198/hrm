...
/* Combining with ci*/
    ...
    ob_end_clean();
    $CI =& get_instance();
	$qclause = $CI->session->userdata('qclause');			
...
<head>
	...
	<title>My App Order Detail Report</title>
	...
	<script type="text/javascript">
		...
		// Decode the String
		//var msql = atob("<?=$qclause?>");		

		report.loadFile("reports/order_detail.mrt");	
		report.dictionary.variables.getByName("condition").valueObject = "<?=$qclause?>";
